...
(
    ...
    CONSTRAINT [FK_PlayerStats_ToPlayer] FOREIGN KEY ([PlayerId]) REFERENCES [Player]([PlayerId]),
    CONSTRAINT [FK_PlayerStats_ToPlayerRole] FOREIGN KEY ([PlayerRoleId]) REFERENCES [PlayerRole]([PlayerRoleId])
